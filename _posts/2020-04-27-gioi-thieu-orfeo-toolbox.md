...
<div style="text-align: justify">Với hơn 15 năm phát triển, Orfeo ToolBox đã phát triển từ một bộ công cụ chỉ chuyên về độ phân giải cao trở thành bộ công cụ viễn thám đa mục đích, đa cảm biến… Nhờ kiến ​​trúc mô-đun, OTB cho khả năng tạo mẫu nhanh và bao trùm đầy đủ các thuật toán xử lý ảnh viễn thám. Từ tiền xử lý đến các phương pháp trích xuất đặc trưng nâng cao, cho phép người dùng đi từ dữ liệu thô đến các sản phẩm có giá trị. Những tính năng tiêu biểu của OTB như:</div>
